function [survival, corrscore, wavescore, autoscore, basescore, score] = iterateSurvival(channel, unit, correlations, wavescore, autoscore, basescore,varargin)
...
maxiter = 5; % default 5 iteration
assignopts(who,varargin);

score = NaN; % pre-allocate 
